        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/ROSAURA12345/SysAlmacen.git'
                }
            }
        }
        stage('Build') {
